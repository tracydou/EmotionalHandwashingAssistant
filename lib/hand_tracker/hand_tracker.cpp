...
/******************************************************************************/
int hand_tracker_start( int argc, char** argv, HandTrackerServerStub* server_stub )
{
	...
	idleTag = g_idle_add( handTrackerIdle, NULL);
...
HandTrackerServerStub::~HandTrackerServerStub() {
