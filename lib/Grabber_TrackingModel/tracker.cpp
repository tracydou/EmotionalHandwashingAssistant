...
/******************************************************************************/
int tracker_start( int argc, char** argv, TrackerServerStub* server_stub )
{
...
bool respondWithRightHandPos(TrackerServerStub* stub) {
...
bool respondWithAction(TrackerServerStub* stub) {
...
bool TrackerServerStub::SendHandPos(Point3_<float> hand_position) {
...
bool TrackerServerStub::SendAction(int action) {
